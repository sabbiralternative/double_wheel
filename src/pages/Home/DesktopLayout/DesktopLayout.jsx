const DesktopLayout = ({ leftWheel, rightWheel, isWin, handleSpin }) => {
  return (
    <div className="for-main-wrapper-holder">
      <div className="main-wrapper-holder">
        <div className="main-wrapper">
          <div className="center-column">
            <div className="inner-center-column">
              <div className="f-g-prov-wrapper">
              ...
              <div className="double-wheel-game-wrapper">
                <div className="double-wheel-game-block">
                ...
                <div className="double-wheel-control-panel">
                  <div className="double-wheel-control-panel-inner">
                    <div className="double-wheel-control-panel-inner-t">
                      <div className="double-num-panel">
                        <div className="double-chance-items shine">
                          ...
                          <div className="double-chance-items-t rainbow">
                            x1.9
                          </div>
                        ...
                        <div className="double-chance-items shine">
                          ...
                          <div className="double-chance-items-t light-red">
                            x15
                          </div>
                          <div className="double-chance-col">
                            <div className="double-chance-col-content">
                        ...
                        <div className="double-chance-items shine">
                          ...
                          <div className="double-chance-items-t orange">
                            x25
                          </div>
                          <div className="double-chance-col">
                            <div className="double-chance-col-content">
                  ...
                  <div className="top-row">
                    <div className="top-row-cell big">
                      <div className="user-row ">
                        ...
                        <div className="user-info-block for-demo">
                    ...
                    <div className="top-row-cell small">
                      <div className="settings-block-container">
                        <div className="icon-block">
                          <span className="ui-lib-settings1" />
                        </div>
                      </div>
                    </div>
                    <div className="top-row-cell small">
                      <div className="icon-block">
                        <span className="ui-lib-question" />
                      </div>
                    </div>
                  </div>
                </div>
                <div className="bottom-inner-wrapper">
                  <div className="inside-inner-wrapper">
                    <div className="top-inside-inner-wrapper">
                      <div className="view-select-row">
                        <div
                          className="view-select-item active"
                          title="Top wins"
                        >
                          <p className="view-select-item-txt">Top wins</p>
                        </div>
                        <div className="view-select-item " title="History">
                          <p className="view-select-item-txt">History</p>
                        </div>
                        <div className="view-select-item-bg" />
                      </div>
                    </div>
                      ...
                      <div className="lists-wrapper">
                        <div className="bottom-of-lists-wrapper">
                          <div className="scrollable-container">
                            <div className="list-item-rows-container ">
                              <div className="list-item-row-component ">
                                <div className="list-item-history ">
                                  <div className="list-item-history-title">
                                    <div className="list-item-history-inner-item big">
                                      <p
                                        className="list-item-history-inner-item-txt big "
                                        title="Player ID"
                                      >
                                        Player ID
                                      </p>
                                  ...
                                  <div className="list-item-history-item">
                                    ...
                                    <div className="list-item-history-inner-item ">
                                      <p
                                        className="list-item-history-inner-item-txt big win-color"
                                        title="7,182.3 FUN"
                                      >
                                        7,182.3 FUN
                                      </p>
          ...
          <div className="timer-holder">
            <i className="ui-lib-time" />
            <span title="16:49:14" className="timer">
              16:49:14
            </span>
          </div>
        </div>
